...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      description:
        "Scalable web development solutions optimized for speed, performance, and growth.",
      icon: Laptop,
      gradient: "from-blue-600 to-sky-600",
      features: [" Blazing-Fast Speed", " Responsive Across Devices", "Offline-Ready"],
    },
    {
          ...
          <div className="w-full max-w-2xl p-8 rounded-3xl bg-slate-900 text-center relative overflow-hidden">
            ...
            <div className="relative space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button onClick={() => window.open('https://zoroinnovations.netlify.app/contact', '_blank')}className="px-8 py-4 rounded-full bg-white text-slate-900 font-medium hover:shadow-lg hover:shadow-white/10 transition-all duration-300 transform hover:-translate-y-0.5">
                  Start Your Project
                </button>
                <button onClick={() => window.open('https://zoroinnovations.netlify.app/team', '_blank')}className="px-8 py-4 rounded-full border-2 border-slate-700 text-white font-medium hover:bg-slate-800 transition-all duration-300">
                  Contact Our Team
                </button>
              </div>
            </div>
