  ...
  const contactInfo = [
    {
      icon: MapPin,
      title: "Our Office",
      details: ["#117 Reddys Colony Street", "Thondebhavi, Gowribidanuru Taluk, Chikkaballapur District, KA 561213"],
      ariaLabel: "Office Location",
    },
    {
      icon: Phone,
      title: "Contact Details",
      details: ["Phone: (+91) 7676012486", "Email: zoroinnovations@yahoo.com"],
      ariaLabel: "Contact Information",
    },
    {
      icon: Clock,
      title: "Business Hours",
      details: ["Mon - Fri: 10:00 AM - 5:00 PM", "Weekends: By appointment"],
