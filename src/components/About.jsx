...
const About = () => {
  const features = [
    ...
    },
    {
      title: "Our Vision",
      description:
        "At Zoro Innovations, we transcend boundaries to redefine the landscape of software innovation. ",
      icon: Eye,
    ...
    },
    {
      title: "Our Values",
      description:
        "At Zoro Innovations, we are driven by a commitment to quality, integrity, and customer satisfaction.",
      icon: Users,
  ...
  const stats = [
    ...
    { number: "29+", label: "Projects Delivered" },
    ...
    <section className="relative py-32 bg-slate-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          For the past four years, we've empowered businesses to transform digitally with forward-thinking, custom-built solutions.
          </p>
        </div>
